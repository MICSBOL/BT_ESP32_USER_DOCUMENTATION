...
\begin{figure}[H]
    ...
    \begin{circuitikz}[scale=0.6, transform shape, font=\large]
        ...
        \node[draw, thick, minimum width=3.8cm, minimum height=4cm] (drv) at (-2,-17) {DRV8833};

        % -----------------------------------------------------
        % Motor A
        % -----------------------------------------------------

        \node[draw, circle, minimum size=0.9cm] (motorA) at (3,-18.0) {M};
        ...
        \node at (4.6,-18.0) {\small DC Motor A};

        % -----------------------------------------------------
        % Motor B
        % -----------------------------------------------------

        \node[draw, circle, minimum size=0.9cm] (motorB) at (3,-15.8) {M};
        ...
        \node at (4.6,-15.8) {\small DC Motor B};
