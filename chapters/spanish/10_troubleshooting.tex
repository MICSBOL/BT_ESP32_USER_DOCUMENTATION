...
\begin{itemize}
    \item \textbf{Android (TeleCon4ESP32):} controles de la interfaz, emparejamiento/conexión Bluetooth y si se están procesando comandos/telemetría.
...
TeleCon4ESP32 soporta diferentes modos de joystick (por ejemplo, spring vs hold). Si el robot se comporta
