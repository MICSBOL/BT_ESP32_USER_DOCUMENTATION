...
\begin{itemize}
    \item \textbf{TeleCon4ESP32 (Android)}: proporciona la interfaz del operador (dos joysticks, interruptores, perillas, botones de evento) además de widgets de telemetría en vivo (paneles, indicadores LED, indicadores analógicos/de batería y gráficas).
