...
\begin{itemize}
    \item \textbf{TeleCon4ESP32 (Android)}: provides the operator interface (dual joysticks, switches, knobs, event buttons) plus live telemetry widgets (panels, LED indicators, analog/battery indicators, and plots).
