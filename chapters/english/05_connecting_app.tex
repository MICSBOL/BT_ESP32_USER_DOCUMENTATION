...
Install the TeleCon4ESP32 Android application on your smartphone using the distribution method provided
...
Power the ESP32 and open the TeleCon4ESP32 app. From the list of available Bluetooth devices, select the
ESP32 controller.
