...
\begin{itemize}
    \item \textbf{Android (TeleCon4ESP32):} UI controls, Bluetooth pairing/connection, and whether commands/telemetry are being processed.
...
TeleCon4ESP32 supports different joystick modes (for example spring vs hold). If the robot behaves
